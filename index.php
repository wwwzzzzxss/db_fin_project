            ...
            <div class="row">
              ...
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><div class="input-field col s12"><label for='.$row["it_id"].' class="">Quantity</label>';
					echo '<input id="'.$row["it_id"].'" name="'.$row['it_id'].'" type="text" data-error=".errorTxt'.$row["it_id"].'"><div class="errorTxt'.$row["it_id"].'"></div></td></tr>';
				}
				?>
                    </tbody>
</table>
